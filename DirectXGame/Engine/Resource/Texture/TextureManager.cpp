...
TextureManager::TextureManager(DXDevice* device, ID3D12GraphicsCommandList* commandList) {
...
int TextureManager::LoadTexture(std::string filePath) {
	...
	textures_.emplace_back(std::make_unique<TextureData>(filePath, device_, commandList_, srvDescriptorHeap));
